...
class _Description extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (fest.description == null || fest.description!.isEmpty) {
      return AppContainer(child: Text(fest.name, style: NewTextStyles.title3Bold));
    }
    return AppContainer(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(fest.name, style: NewTextStyles.title3Bold),
          ...
          const SizedBox(height: Paddings.small),
          LinkButton('Подробнее', onTap: () => openScreen(_DescriptionPage(fest)))
        ],
      ),
    );
  }
            ...
            AppContainer(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: Paddings.small),
                  Text(fest.description!, style: NewTextStyles.bodyRegular),
                ],
              ),
            ),
